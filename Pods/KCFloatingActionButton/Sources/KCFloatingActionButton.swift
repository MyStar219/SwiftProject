    ...
    */
    ...
    private func setButtonImage() {
        ...
        buttonImageView.frame = CGRectMake(
            0,
            0,
            self.frame.width * 0.8,
            self.frame.height * 0.8
        )
        buttonImageView.center.x = self.frame.width / 2 + self.frame.width * 0.05
        buttonImageView.center.y = self.frame.height / 2 + self.frame.width * 0.05
